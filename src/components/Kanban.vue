<template>
  <div class="kanban">
    <div
      class="colume"
      :style="{ backgroundColor: colume.color }"
      v-for="(colume, index) in data"
      :key="index"
    >
...
export default {
  ...
  methods: {
    ...
    submit_create_task() {
      this.create_task_submit(this.current_colume_index, {
    ...
    drop_item(colusme_index, task_index) {
      this.move_item_task(
          this.current_colume_index,
